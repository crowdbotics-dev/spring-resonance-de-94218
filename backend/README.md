...
## Project Structure
    ...
    ├── spring_resonance_de_94218  # Django project configurations
...
1. Clone this repo and `cd spring_resonance_de_94218`
...
2. Clone this repo and `cd spring_resonance_de_94218`
